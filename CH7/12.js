...
(function (global, factory) {
    ...
    function bin() {
        ...
        function histogram(data) {
            ...
            if (!Array.isArray(tz)) {
                ...
                // If the last threshold is coincident with the domain鈥檚 upper bound, the
                // last bin will be zero-width. If the default domain is used, and this
                // last threshold is coincident with the maximum input value, we can
                // extend the niced upper bound by one tick to ensure uniform bin widths;
                // otherwise, we simply remove the last threshold. Note that we don鈥檛
    ...
    // selection; we don鈥檛 ever want to create a selection backed by a live
    ...
    // selectAll, this isn鈥檛 worried about 鈥渓ive鈥� collections because the resulting
    // array will only be used briefly while data is being bound. (It is possible to
    // cause the data to change while iterating by using a key function, but please
    // don鈥檛; we鈥檇 rather avoid a gratuitous copy.)
    ...
    // "/foo/bar" 鈬� "/foo", "/foo" 鈬� "/", "/" 鈫� "". (The root is special-cased
